...
int main(void)
{
  ...
  osThreadDef(NetTask, StartNetTask, osPriorityNormal, 0, 128);
  NetTaskHandle = osThreadCreate(osThread(NetTask), NULL);

  /* definition and creation of ReadSensors */
  osThreadDef(ReadSensors, StartReadSensorsTask, osPriorityNormal, 0, 128);
  ReadSensorsHandle = osThreadCreate(osThread(ReadSensors), NULL);

  /* definition and creation of Drive */
  osThreadDef(Drive, StartDriveTask, osPriorityNormal, 0, 128);
...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, BoardLight_Pin|ReceiverOn_Pin|Relay3_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(Relay1_GPIO_Port, Relay1_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, Relay6_Pin|Relay2_Pin|Relay8_Pin|Relay4_Pin 
                          |Relay5_Pin|Led1_Pin|Relay7_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : BoardLight_Pin ReceiverOn_Pin Relay3_Pin */
  GPIO_InitStruct.Pin = BoardLight_Pin|ReceiverOn_Pin|Relay3_Pin;
  ...
  /*Configure GPIO pins : ProximitySensor2_Pin ProximitySensor1_Pin MovingSensor1_Pin */
  GPIO_InitStruct.Pin = ProximitySensor2_Pin|ProximitySensor1_Pin|MovingSensor1_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

  /*Configure GPIO pins : Relay6_Pin Relay2_Pin Relay8_Pin Relay4_Pin 
                           Relay5_Pin Led1_Pin Relay7_Pin */
  GPIO_InitStruct.Pin = Relay6_Pin|Relay2_Pin|Relay8_Pin|Relay4_Pin 
                          |Relay5_Pin|Led1_Pin|Relay7_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
/**
* @brief Function implementing the Drive thread.
* @param argument: Not used
* @retval None
*/
